...
public class AcessoControllerTest {
    ...
    @Test
    public void deve_retornar_token_apos_realizar_login() throws NotFoundException, BusinessException {
    ...
    public void deve_retornar_token_apos_realizar_cadastro() throws BusinessException {
        ...
        var actual = controller.realizarCadastro(contaRepresentation);
    ...
    public void deve_lancar_business_exception_caso_email_existente() {
        assertThrows(BusinessException.class, () -> controller.realizarCadastro(contaRepresentation));
    }
}
